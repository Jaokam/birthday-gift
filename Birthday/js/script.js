...
const storyPoints = [

  {
    x: 1000,
    text:
      "ถ้าย้อนกลับไปคิดดี ๆ... ปีนี้เธอผ่านอะไรมาเยอะเหมือนกันนะ"
  },

  {
    x: 2300,
    text:
      "มีทั้งเรื่องที่ดี เรื่องที่เหนื่อย และเรื่องเล็ก ๆ ที่อาจจำไม่ได้แล้ว"
  },

  {
    x: 3300,
    text:
      "แต่ทั้งหมดนั้นก็ค่อย ๆ กลายเป็นเธอในวันนี้"
  }
      ...
      */
      ...
      if (
        ...
        if (
          ...
          storyText.textContent =
            "เดินมาถึงตรงนี้แล้ว... มีอะไรอยากเล่าให้ฉันฟังบ้างไหม?";
...
const questions = [
  ...
  "ถ้าตอนนี้ไปไหนก็ได้ เธออยากไปที่ไหน?",

  "มีอะไรที่เธออยากลองทำสักครั้งไหม?",

  "เวลาเหนื่อย ๆ เธออยากให้คนข้าง ๆ ทำอะไรให้?",

  "แล้ววันเกิดปีนี้ แกอยากให้ตัวเองมีความสุขกับอะไรที่สุด?"
